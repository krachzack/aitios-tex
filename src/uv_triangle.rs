use geom::{Triangle, TupleTriangle, FromVertices, TangentSpace, Texcoords, Position, Vec3, Vec2};
            ...
            V : Position + Texcoords
{
    ...
    TupleTriangle::new(
        UvVtx { uv_position: texcoord0, world_position: worldpos0 },
        UvVtx { uv_position: texcoord1, world_position: worldpos1 },
        UvVtx { uv_position: texcoord2, world_position: worldpos2 },
    )
}
